...
public class RobotEnemy : MonoBehaviour
{
    ...
    private void SpawnExplosionVisuals()
    {
        ...
        // Reproducir sonido de explosión. Se carga desde Resources para que funcione
        // TANTO en el Editor como en la build (AssetDatabase no existe en la build).
        AudioClip expSound = Resources.Load<AudioClip>("Audio/snd_explosion_solid");
#if UNITY_EDITOR
        if (expSound == null)
            expSound = UnityEditor.AssetDatabase.LoadAssetAtPath<AudioClip>("Assets/SpriteSheets/sounds/snd_explosion_solid.ogg");
#endif
        if (expSound != null)
        {
